...
<style>
  ...
  <script type="text/javascript">
    ...
    var data = new google.visualization.DataTable();
        ...
        <?php
					extract(mysql_fetch_array(mysql_query("SELECT COUNT(*) AS cuantos FROM ce_camino_solar_48t WHERE intcero !=0")));					
				?>
        data.addRows(<?php echo $cuantos;?>);
				<?php
					$row = mysql_query("SELECT tiempo AS fecha, intcero FROM ce_camino_solar_48t WHERE intcero !=0");			
					$i=0;
