...
*/
function crear_tabla_fvrespuesta($idterreno, $idfotovol) {
/* Funcion para crear la tabla de respuesta para el fotovoltaico correspondiente
 * y para senalar en tabla de cd_fotovoltaico que ya tiene su tabla creada.
 ...
 */
	...
	while ($row = mysql_fetch_array($result)) {
		...
		// Hay que guardar los valores generados en la tabla de ce_fotovoltaico_respuesta_txfvx
